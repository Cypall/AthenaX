...
static void display_title(void) {
	...
	ShowMessage("" CL_PASS " " CL_BT_WHITE "                 AthenaX                     " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "  AAA   t   h                          x   x " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " A   A ttt  h      eeeee  n     aaaaa   x x  " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " AAAAA  t   hhhh  eeeeeee nnnn   aaaa    x   " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " A   A  t   h   h e       n   n a   a   x x  " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " A   A  ttt h   h  eeeee  n   n  aaaaa x   x " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                             " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
